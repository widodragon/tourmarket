...
const TermOfUse: FC = () => {
  ...
  const renderContent = () => (
    <div className="w-full flex flex-col items-center justify-center rounded-2xl border border-neutral-200 dark:border-neutral-700 space-y-8 px-3 p-2 xl:p-6">
      <p className="text-lg lg:text-3xl font-semibold">Syarat Penggunaan</p>
      <p className="text-center text-sm lg:text-lg">{config?.termsOfUse}</p>
    </div>
  );
  ...
  return (
    <main className="container mt-11 mb-24 lg:mb-32 ">
      <Helmet>
        <title>{getTitleWebsite()} - Term of Use</title>
      </Helmet>
